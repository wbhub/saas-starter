...
export default async function DashboardUsagePage() {
  ...
  return (
    <DashboardShell
      ...
      csrfToken={csrfToken}
    >
      <header className="relative overflow-hidden rounded-2xl border app-border-subtle bg-gradient-to-br from-blue-500/5 via-transparent to-cyan-500/5 p-6 shadow-sm sm:p-8">
