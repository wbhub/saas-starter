...
export function AiChatCard({
  ...
  return (
    <div className="flex min-h-[32rem] flex-col overflow-hidden rounded-2xl bg-card ring-1 ring-border lg:h-[min(58rem,calc(100dvh-11rem))] lg:min-h-0 lg:flex-row">
