export type AttachmentProviderName = "openai" | "anthropic" | "google";
...
const SUPPORTED_FILE_MIME_TYPE_LIST_BY_PROVIDER: Record<
...
const SUPPORTED_FILE_MIME_TYPES_BY_PROVIDER: Record<
  AttachmentProviderName,
  ReadonlySet<string>
> = {
...
export function isSupportedFileMimeType(
  mimeType: string,
